(一)项目简介  
  1.本项目是基于MQTT+HTTP网关的高并发分布式轮次调度系统  
  ...
  ---------------------------------------------------------------------------------------------  
  （九）开发背景  
  本项目为本人在学习高并发调度与分布式协同控制过程中所完成的实践项目。
  介于本人目前仅有专科计算机系应届毕业生一年半且并无实际意义上的工作经验，其中的不足之处还有更多更好的方式来优化掉，但是碍于技术能力仅能做到现有地步，除去Lua客户端、易语言中控端其余技术更多的是借鉴了Ai与技术文档以及前辈所给出的建议进行修改  
  ---------------------------------------------------------------------------------------------    
